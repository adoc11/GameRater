...
public class GameRater extends JFrame {
	...
	public class AddViewRemoveListener implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent e) 
		{
			...
			{
				gameTable.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
			...
			{
				int inx = gameTable.convertRowIndexToModel(GameRater.gameTable.getSelectedRow());
				Object game = ((Vector)tblmodel.getDataVector()).elementAt(inx);
		...
		gameTable.addMouseListener(new MouseAdapter() {
		    public void mousePressed(MouseEvent me) {
		        ...
		        if (me.getClickCount() == 2) {
		        	...
		        	{
				        //changeDialogWindow.setModal(true);
		        		// changeDialogWindow.pack();
		        		if(!isReviewDialog) 
